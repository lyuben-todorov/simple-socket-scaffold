Read every comment. This project is a simple scaffold for a socket-based game without any external libraries other than express for the server of course the ws implementation. It
